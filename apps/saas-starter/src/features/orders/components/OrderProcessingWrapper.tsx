...
import { MOCK_ORDERS } from '../__mocks__/mockOrders';
import {
  DEFAULT_ORDER_PAGE_FILTERS,
  DEFAULT_ORDER_SORT,
  type OrderPageFilters,
} from '../types/filters';
import type { ProcessingOrder } from '../types/models';
...
const MOCK_ICON_TABS: IconTabItem[] = [
  ...
  { value: 'change-status', label: 'Change Status', icon: Package },
...
export function OrderProcessingWrapper() {
  ...
  return (
    <>
      ...
      <SimpleStatusCarousel name="activeTab" control={control} tabs={statusTabs} />
